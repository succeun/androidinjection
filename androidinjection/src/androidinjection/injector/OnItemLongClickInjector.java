...
import androidinjection.annotation.OnItemLongClick;


public class OnItemLongClickInjector extends MethodInjector {

	@Override
	public Class<? extends Annotation> getTarget() {
		return OnItemLongClick.class;
	}
        ...
        for (int id : ids) {
	        ...
	        view.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
					...
					Object returnValue = invoke(argumentOrders[type], invocation, parent, view, position, id, clickedItem);
